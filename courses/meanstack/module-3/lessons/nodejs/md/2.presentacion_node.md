...
Para exportar funciones o variables de un módulo se utiliza el objeto __`module.exports`__ o __`exports`__. _`Exports`_ es un objeto especial que se incluye en todos los ficheros JS de Node, por defecto. _module_ es una variable que representa el módulo actual y _exports_ es un objeto que se expondrá como módulo

      // book.js
      module.exports.name = 'pepe'; //asigna un valor al módulo
      module.exports.read = function() { 
      console.log('Hola ' + exports.name);
      } //asigna una función a la propiedad read del objeto exports (devolvería {read: function(){...}})
