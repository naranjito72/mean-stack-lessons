...
Importar el fichero de nombre [`contacts.json`](http://bcncodes.academy/public/data/contacts.json) en una base de datos `projectBeta` en una colección `contacts`
<hr>
???
