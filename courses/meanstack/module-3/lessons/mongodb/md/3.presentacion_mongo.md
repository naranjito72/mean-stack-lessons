...
<img src="https://imgur.com/VXomHj5.png" class=centered>
...
Importar el fichero de nombre [`contacts.json`](mean-stack-lessons\public\data\contacts.json) en una base de datos `projectBeta` en una colección `contacts`
<hr>
???
